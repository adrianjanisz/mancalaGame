...
public class KalahRulesTest {
    ...
    public void customTest() {
        rules.distributeStones(1);
        rules.distributeStones(5);
        rules.distributeStones(9);
        assertEquals(player1.getStoreCount(), 1);
        assertEquals(player2.getStoreCount(), 0);
        assertEquals(data.getNumStones(1), 1);
        assertEquals(0,data.getNumStones(12), 5);
    }
}